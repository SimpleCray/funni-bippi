...
export function LandingScreen({
  ...
  return (
    <div className='landing fade-screen'>
      ...
      <div
        className='deco-bubble float'
        style={{ bottom: '22%', right: '11%', animationDelay: '1s' }}
      >
      ...
      <div className='landing-hero'>
        ...
        <p className='hero-sub'>
          One tap drops you into a friendly chat with a real human somewhere on Earth. No profiles,
          no pressure — just good conversation and great vibes.
        </p>
