...
export function SettingsModal({ onClose }: SettingsModalProps) {
  const { accent, setAccent, theme, setTheme, notifyMatch, setNotifyMatch, notifySound, setNotifySound, showTyping, setShowTyping } = useSettingsStore()
  ...
  return (
    <div
      ...
      onMouseDown={e => { if ((e.target as HTMLElement).classList.contains('modal-scrim')) onClose() }}
    >
