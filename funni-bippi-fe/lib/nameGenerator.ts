...
const ADJ = [
  'Blue','Mint','Coral','Sunny','Cosmic','Velvet','Toasty','Jazzy',
  'Pixel','Maple','Lucky','Breezy','Cocoa','Peachy','Frosty','Goldn',
  'Misty','Zesty','Plush','Echo',
]
const ANIMALS = [
  'Otter','Panda','Koala','Fox','Penguin','Narwhal','Axolotl','Yeti',
  'Llama','Quokka','Puffin','Wombat','Tapir','Lynx','Manatee','Hedgehog','Capybara',
]
const COUNTRIES = [
  '🌍 Somewhere','🛰 Online','🌙 Night owl','☕ Café','🏝 Far away','🚆 Commuting',
]
const INTERESTS = [
  'lo-fi beats','street food','retro games','hiking','sci-fi','houseplants',
  'bad puns','film photography','cats','baking','astronomy','skating',
]
